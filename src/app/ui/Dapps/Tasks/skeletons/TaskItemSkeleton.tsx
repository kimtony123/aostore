                ...
                <div className="flex flex-col md:flex-row justify-between gap-4 mb-4">
                    ...
                    <div className="md:w-1/3 flex flex-col items-center justify-center bg-white dark:bg-gray-900 p-4 rounded-lg border border-indigo-100 dark:border-gray-700">
                        <div className="space-y-2 w-full">
                            <div className="h-4 w-3/4 mx-auto bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse" />
                            <div className="h-6 w-3/4 mx-auto bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse" />
                        </div>
                    </div>
                </div>
